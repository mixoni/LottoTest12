         ...
         fetch("api/GetData")
          ...
          .then(
            (result) => {
              ...
              this.setState({ component : <Animation data={1752445524} numbers={numbers} onComplete = {this.RenderLastThreeResultsScene} /*onTimerExpired={this.RenderCountdownScene}*/ /> })              
            },
            (error) => {
              console.log(error);
            }
